...
- **Walkthrough video (Drive)** — [20260425-1732-09.1854228.mp4](https://drive.google.com/file/d/1pz_9nKM4pYhxh6fBFh3QO-YK3VMoZiLQ/view?usp=sharing)

**Info session highlights (transcript):** judging stresses **technical depth** of bugs and fixes, **real-world FinTech impact** (fraud prevention, traceable records, calculations, UX, performance), **clear documentation**, and a **bug-primary** PDF; confirm **final deadline** against the **official PDF §7** if sources differ.
